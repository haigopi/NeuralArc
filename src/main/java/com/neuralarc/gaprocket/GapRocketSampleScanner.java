...
public final class GapRocketSampleScanner {
    public List<GapRocketCandidate> candidates() {
        return List.of(
                candidate("NVDA", "NVIDIA Corporation", "7.2", 5_200_000L, "6.1", "202.40", "188.80", "203.60", "197.20", GapRocketConfig.CatalystType.EARNINGS, "Earnings beat with strong AI datacenter guidance.", true, true, "0.35", "200.80"),

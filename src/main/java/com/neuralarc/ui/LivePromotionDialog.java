...
final class LivePromotionDialog extends JDialog {
    ...
    private void buildUi(StrategyService.LivePromotionPreview preview, String realizedPnl, String unrealizedPnl) {
        ...
        lossBuyLevelsEnabled = strategy.lossBuyLevelsEnabled();
        ...
        if (lossBuyLevelsEnabled) {
            ...
            addRow(content, gbc, "Buy Level 1", money(strategy.buyLimit1Price()) + " x " + strategy.buyLimit1Quantity() + " (disabled)");
            addRow(content, gbc, "Buy Level 2", money(strategy.buyLimit2Price()) + " x " + strategy.buyLimit2Quantity() + " (disabled)");
        }
        ...
        JLabel editHint = new JLabel("<html><span style='color:#6B7785;'>Editable: base price &amp; qty"
                + (lossBuyLevelsEnabled ? ", loss buy level prices &amp; qtys" : "")
                + ", target sell price. All other settings are cloned from the paper strategy.</span></html>");
        ...
        pricingValidationLabel.setForeground(new Color(183, 28, 28));
        gbc.gridy++;
        gbc.gridx = 0;
        gbc.gridwidth = 2;
        gbc.weightx = 1.0;
    ...
    private void updatePromoteButtonEnabled(StrategyService.LivePromotionPreview preview) {
        ...
        pricingValidationLabel.setText(fieldsValid ? " " : "Check: " + escapeHtml(error));

    ...
    static List<PortfolioActionsMenu.Group> groups(PortfolioActionsController controller, boolean liveView) {
        ...
        return List.of(
                ...
                new PortfolioActionsMenu.Group("Clean Up Grids", "icons/delete.svg", List.of(
                        ...
                        new PortfolioActionsMenu.Entry("Clean Pending and Cancelled Rows",
                                "Delete rows waiting to place a base buy and rows you cancelled, in one sweep.",
                                "icons/delete.svg",
                                controller::handleCleanPendingAndCanceled),

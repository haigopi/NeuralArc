...
public final class EarningsHunterPanel extends JPanel {
    ...
    public static final String EXAMPLE = "A stock reports earnings or guidance news within the last week, trades above normal volume, and holds a liquid price range; Earnings Hunter studies daily lows across roughly 1, 3, and 6 months, then plans a limit-buy entry below current price near support.";
    public static final String FIELD_GUIDANCE = "Know before you make a next move:\n"
            ...
            + "Entry Discount is a safety cap; the final base buy uses the lower of the flat discount or the multi-month daily-low support-gravity entry.";
    ...
    public EarningsHunterPanel(Runnable onAnalyze, boolean showButton) {
        ...
        JLabel text = new JLabel("<html><div style='text-align:left; width:430px;'>"
                ...
                + "<li><b>Support-gravity entry:</b> uses the lowest daily lows across roughly 1, 3, and 6 months, then waits below current price for a better fill.</li>"

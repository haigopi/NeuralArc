# NeuralArc Windows Release 1.5.5

## Artifact
- File: NeuralArc-1.5.5.exe
- Path: artifacts/windows/NeuralArc-1.5.5.exe
...
powershell:
  Get-FileHash "C:\path\to\NeuralArc-1.5.5.exe" -Algorithm SHA256

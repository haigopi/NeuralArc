# NeuralArc Windows Release 1.5.4

## Artifact
- File: NeuralArc-1.5.4.exe
- Path: artifacts/windows/NeuralArc-1.5.4.exe
...
powershell:
  Get-FileHash "C:\path\to\NeuralArc-1.5.4.exe" -Algorithm SHA256
